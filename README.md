...
4. **Extract the Files**
   Once the download is complete, navigate to your downloads folder and extract the downloaded ZIP file. Right-click on the ZIP file and select “Extract All”. Follow the prompts.
